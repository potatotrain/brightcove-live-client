...
content_type = 'application/json' # String | Content-Type: application/json
x_api_key = 'x_api_key_example' # String | X-API-KEY: {Your_Live_API_Key}
add_ad_matadatabody = OpenapiClient::AddAdMatadatabody.new # AddAdMatadatabody | Contains a set of key/value pairs for ad requests.
...
content_type = 'application/json' # String | Content-Type: application/json
x_api_key = 'x_api_key_example' # String | X-API-KEY: {Your_Live_API_Key}
create_live_job_request_body = OpenapiClient::CreateLiveJobRequestBody.new # CreateLiveJobRequestBody | Create a live stream
...
x_api_key = 'x_api_key_example' # String | X-API-KEY: {Your_Live_API_Key}
opts = {
  create_playback_token_request_body: OpenapiClient::CreatePlaybackTokenRequestBody.new # CreatePlaybackTokenRequestBody | Create a live stream
}
...
opts = {
  ...
  state: OpenapiClient::OneOfstringarray.new, # OneOfstringarray | Filter results by one or more job states
  ssai_state: OpenapiClient::OneOfstringarray.new, # OneOfstringarray | Filter results by one or more SSAI states
  region: OpenapiClient::OneOfstringarray.new # OneOfstringarray | Filter results by one or more regions
}
