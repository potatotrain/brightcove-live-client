...
# Unit tests for BrightcoveLive::VodJobs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'VodJobs' do
  before do
    # run before each test
    @instance = BrightcoveLive::VodJobs.new
  end
  ...
  describe 'test an instance of VodJobs' do
    it 'should create an instance of VodJobs' do
      expect(@instance).to be_instance_of(BrightcoveLive::VodJobs)
    end
  end
