...
# Unit tests for BrightcoveLive::CreateVodClipbodyOutputsVideocloudIngestTextTracks
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateVodClipbodyOutputsVideocloudIngestTextTracks' do
  before do
    # run before each test
    @instance = BrightcoveLive::CreateVodClipbodyOutputsVideocloudIngestTextTracks.new
  end
  ...
  describe 'test an instance of CreateVodClipbodyOutputsVideocloudIngestTextTracks' do
    it 'should create an instance of CreateVodClipbodyOutputsVideocloudIngestTextTracks' do
      expect(@instance).to be_instance_of(BrightcoveLive::CreateVodClipbodyOutputsVideocloudIngestTextTracks)
    end
  end
