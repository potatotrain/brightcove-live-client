...
# Unit tests for OpenapiClient::PlaybackAddedCdns
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'PlaybackAddedCdns' do
  before do
    # run before each test
    @instance = OpenapiClient::PlaybackAddedCdns.new
  end
  ...
  describe 'test an instance of PlaybackAddedCdns' do
    it 'should create an instance of PlaybackAddedCdns' do
      expect(@instance).to be_instance_of(OpenapiClient::PlaybackAddedCdns)
    end
  end
