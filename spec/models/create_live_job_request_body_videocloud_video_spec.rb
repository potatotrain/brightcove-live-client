...
# Unit tests for BrightcoveLive::CreateLiveJobRequestBodyVideocloudVideo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateLiveJobRequestBodyVideocloudVideo' do
  before do
    # run before each test
    @instance = BrightcoveLive::CreateLiveJobRequestBodyVideocloudVideo.new
  end
  ...
  describe 'test an instance of CreateLiveJobRequestBodyVideocloudVideo' do
    it 'should create an instance of CreateLiveJobRequestBodyVideocloudVideo' do
      expect(@instance).to be_instance_of(BrightcoveLive::CreateLiveJobRequestBodyVideocloudVideo)
    end
  end
