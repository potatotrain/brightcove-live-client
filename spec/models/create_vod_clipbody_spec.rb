...
# Unit tests for BrightcoveLive::CreateVodClipbody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateVodClipbody' do
  before do
    # run before each test
    @instance = BrightcoveLive::CreateVodClipbody.new
  end
  ...
  describe 'test an instance of CreateVodClipbody' do
    it 'should create an instance of CreateVodClipbody' do
      expect(@instance).to be_instance_of(BrightcoveLive::CreateVodClipbody)
    end
  end
