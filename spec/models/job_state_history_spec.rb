...
# Unit tests for BrightcoveLive::JobStateHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JobStateHistory' do
  before do
    # run before each test
    @instance = BrightcoveLive::JobStateHistory.new
  end
  ...
  describe 'test an instance of JobStateHistory' do
    it 'should create an instance of JobStateHistory' do
      expect(@instance).to be_instance_of(BrightcoveLive::JobStateHistory)
    end
  end
