...
# Unit tests for BrightcoveLive::JobStreamLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'JobStreamLocation' do
  before do
    # run before each test
    @instance = BrightcoveLive::JobStreamLocation.new
  end
  ...
  describe 'test an instance of JobStreamLocation' do
    it 'should create an instance of JobStreamLocation' do
      expect(@instance).to be_instance_of(BrightcoveLive::JobStreamLocation)
    end
  end
