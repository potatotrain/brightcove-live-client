...
# Unit tests for BrightcoveLive::ApplicationAdConfiguration
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ApplicationAdConfiguration' do
  before do
    # run before each test
    @instance = BrightcoveLive::ApplicationAdConfiguration.new
  end
  ...
  describe 'test an instance of ApplicationAdConfiguration' do
    it 'should create an instance of ApplicationAdConfiguration' do
      expect(@instance).to be_instance_of(BrightcoveLive::ApplicationAdConfiguration)
    end
  end
