...
# Unit tests for OpenapiClient::CreateVodClip200
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateVodClip200' do
  before do
    # run before each test
    @instance = OpenapiClient::CreateVodClip200.new
  end
  ...
  describe 'test an instance of CreateVodClip200' do
    it 'should create an instance of CreateVodClip200' do
      expect(@instance).to be_instance_of(OpenapiClient::CreateVodClip200)
    end
  end
