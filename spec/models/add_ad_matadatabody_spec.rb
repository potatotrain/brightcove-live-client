...
# Unit tests for BrightcoveLive::AddAdMatadatabody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'AddAdMatadatabody' do
  before do
    # run before each test
    @instance = BrightcoveLive::AddAdMatadatabody.new
  end
  ...
  describe 'test an instance of AddAdMatadatabody' do
    it 'should create an instance of AddAdMatadatabody' do
      expect(@instance).to be_instance_of(BrightcoveLive::AddAdMatadatabody)
    end
  end
