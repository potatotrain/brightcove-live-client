...
# Unit tests for BrightcoveLive::CreateLiveJobRequestBodyAddCdnsTokenAuth
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'CreateLiveJobRequestBodyAddCdnsTokenAuth' do
  before do
    # run before each test
    @instance = BrightcoveLive::CreateLiveJobRequestBodyAddCdnsTokenAuth.new
  end
  ...
  describe 'test an instance of CreateLiveJobRequestBodyAddCdnsTokenAuth' do
    it 'should create an instance of CreateLiveJobRequestBodyAddCdnsTokenAuth' do
      expect(@instance).to be_instance_of(BrightcoveLive::CreateLiveJobRequestBodyAddCdnsTokenAuth)
    end
  end
