...
module OpenapiClient
  class CredentialsApi
    ...
    # @param create_credentialbody [CreateCredentialbody] Create a new credential.
    ...
    # @param create_credentialbody [CreateCredentialbody] Create a new credential.
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreateCredential, Integer, Hash)>] CreateCredential data, response status code and response headers
    def create_credential_with_http_info(content_type, x_api_key, create_credentialbody, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(create_credentialbody) 

      # return_type
      return_type = opts[:return_type] || 'CreateCredential' 
    ...
    # Delete Credential
    # Delete a credential. 
    # @param credential_id [String] A credential ID
    # @param content_type [String] Content-Type: application/json
    # @param x_api_key [String] X-API-KEY: {Your_Live_API_Key}
    # @param [Hash] opts the optional parameters
    # @return [nil]
    ...
    def delete_credential_with_http_info(credential_id, content_type, x_api_key, opts = {})
      ...
      # resource path
      local_var_path = '/credentials/{credential_id}'.sub('{' + 'credential_id' + '}', credential_id.to_s)
    ...
    # @param x_api_key [String] X-API-KEY: {Your_Live_API_Key}
    # @param [Hash] opts the optional parameters
    # @return [Array<(ListCredentials, Integer, Hash)>] ListCredentials data, response status code and response headers
    def list_credentials_with_http_info(content_type, x_api_key, opts = {})
      ...
      # return_type
      return_type = opts[:return_type] || 'ListCredentials' 
    ...
    # @param content_type [String] Content-Type: application/json
    # @param x_api_key [String] X-API-KEY: {Your_Live_API_Key}
    # @param update_credentialbody [UpdateCredentialbody] Update a credential.
    # @param [Hash] opts the optional parameters
    ...
    # @param update_credentialbody [UpdateCredentialbody] Update a credential.
    # @param [Hash] opts the optional parameters
    # @return [Array<(UpdateCredential, Integer, Hash)>] UpdateCredential data, response status code and response headers
    def update_credential_with_http_info(credential_id, content_type, x_api_key, update_credentialbody, opts = {})
      ...
      # http body (model)
      post_body = opts[:body] || @api_client.object_to_http_body(update_credentialbody) 

      # return_type
      return_type = opts[:return_type] || 'UpdateCredential' 
