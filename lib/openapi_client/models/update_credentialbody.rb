...
module OpenapiClient
  class UpdateCredentialbody
    ...
    def self.openapi_types
      {
        ...
        :'oauth_settings' => :'UpdateCredentialbodyOauthSettings'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'credential_label')
      ...
      if attributes.has_key?(:'oauth_settings')
    ...
    def valid?
      ...
      credential_type_validator = EnumAttributeValidator.new('String', ['ftp', 'oauth', 's3', 'videocloud', 'zencoder'])
    ...
    def hash
      [user_id, credential_default_for_type, credential_label, credential_type, credential_private, credential_public, oauth_settings].hash
    end
