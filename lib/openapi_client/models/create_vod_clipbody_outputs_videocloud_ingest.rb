...
module OpenapiClient
  class CreateVodClipbodyOutputsVideocloudIngest
    ...
    # Whether Video Cloud should capture poster and thumbnail images at the midpoint of the clip
    attr_accessor :capture_images

    # An array of URLs that nofications for the ingest job should be sent to
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'capture-images')
        self.capture_images = attributes[:'capture-images']
      end
    ...
    def hash
      [profile, capture_images, callbacks].hash
    end
