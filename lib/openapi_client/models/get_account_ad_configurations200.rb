...
module OpenapiClient
  class GetAccountAdConfigurations200
    # Whether the ad application was successfully inserted
    ...
    def list_invalid_properties
      ...
      if @inserted.nil?
        invalid_properties.push('invalid value for "inserted", inserted cannot be nil.')
      end
