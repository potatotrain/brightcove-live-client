...
module BrightcoveLive
  ...
  class CreateLiveJobRequestBodyVideocloudVideo
    ...
    def self.openapi_types
      {
        :'cue_points' => :'Array<CreateLiveJobRequestBodyVideocloudVideoCuePoint>',
        :'custom_fields' => :'Object',
        :'description' => :'String',
        :'drm_disabled' => :'Boolean',
        :'economics' => :'String',
        :'geo' => :'CreateLiveJobRequestBodyVideocloudVideoGeo',
        :'long_description' => :'String',
        :'name' => :'String',
        :'reference_id' => :'String',
        :'schedule' => :'CreateLiveJobRequestBodyVideocloudVideoSchedule',
        :'state' => :'String',
        :'tags' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BrightcoveLive::CreateLiveJobRequestBodyVideocloudVideo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BrightcoveLive::CreateLiveJobRequestBodyVideocloudVideo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
