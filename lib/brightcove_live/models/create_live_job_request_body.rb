...
module BrightcoveLive
  class CreateLiveJobRequestBody
    ...
    # An array of [CIDR](https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing) blocks.  **Required for ALL jobs where `protocol` = `rtp`, `rtp-fec`, or `srt`.**  This property is **not** allowed for RTMP jobs (API will return an error).
    attr_accessor :cidr_whitelist

    # An array of IP addresses.  This property is **not** allowed for jobs where `protocol` = `rtp`, `rtp-fec`, or `srt`. (API will return an error).
    ...
    # The label for an RTMP credential to protect the RTMP stream
    attr_accessor :rtmp_credentials
    ...
    def self.attribute_map
      {
        ...
        :'region' => :'region',
        :'rtmp_credentials' => :'rtmp_credentials',
    ...
    def self.openapi_types
      {
        ...
        :'add_cdns' => :'Array<CreateLiveJobRequestBodyAddCdns>',
        :'beacon_set' => :'String',
        :'channel_type' => :'String',
        :'cidr_whitelist' => :'Array<String>',
        :'ip_whitelist' => :'Array<String>',
        :'encryption' => :'CreateLiveJobRequestBodyEncryption',
        ...
        :'outputs' => :'Array<CreateLiveJobRequestBodyOutputs>',
        :'protocol' => :'String',
        :'reconnect_time' => :'Integer',
        :'region' => :'String',
        :'rtmp_credentials' => :'String',
        :'rtmp_ip_whitelist' => :'Array<String>',
        :'slate' => :'String',
        :'static' => :'Boolean',
        :'videocloud' => :'CreateLiveJobRequestBodyVideocloud'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BrightcoveLive::CreateLiveJobRequestBody` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BrightcoveLive::CreateLiveJobRequestBody`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'add_cdns')
        if (value = attributes[:'add_cdns']).is_a?(Array)
          self.add_cdns = value
        end
      end

      if attributes.key?(:'beacon_set')
      ...
      if attributes.key?(:'cidr_whitelist')
        if (value = attributes[:'cidr_whitelist']).is_a?(Array)
          self.cidr_whitelist = value
        end
      end

      if attributes.key?(:'ip_whitelist')
        if (value = attributes[:'ip_whitelist']).is_a?(Array)
      ...
      if attributes.key?(:'rtmp_credentials')
        self.rtmp_credentials = attributes[:'rtmp_credentials']
      end

      if attributes.key?(:'rtmp_ip_whitelist')
    ...
    def list_invalid_properties
      ...
      if !@live_dvr_sliding_window_duration.nil? && @live_dvr_sliding_window_duration < 1
        invalid_properties.push('invalid value for "live_dvr_sliding_window_duration", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@live_dvr_sliding_window_duration.nil? && @live_dvr_sliding_window_duration < 1
      ...
      protocol_validator = EnumAttributeValidator.new('String', ["rtmp", "rtp", "rtp-fec", "srt"])
      ...
      region_validator = EnumAttributeValidator.new('String', ["us-west-2", "us-east-1", "ap-southeast-2", "ap-northeast-1", "ap-southeast-1", "ap-south-1", "eu-central-1", "eu-west-1"])
    ...
    def live_dvr_sliding_window_duration=(live_dvr_sliding_window_duration)
      ...
      if !live_dvr_sliding_window_duration.nil? && live_dvr_sliding_window_duration < 1
        fail ArgumentError, 'invalid value for "live_dvr_sliding_window_duration", must be greater than or equal to 1.'
      end
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ["rtmp", "rtp", "rtp-fec", "srt"])
    ...
    def region=(region)
      validator = EnumAttributeValidator.new('String', ["us-west-2", "us-east-1", "ap-southeast-2", "ap-northeast-1", "ap-southeast-1", "ap-south-1", "eu-central-1", "eu-west-1"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          region == o.region &&
          rtmp_credentials == o.rtmp_credentials &&
    ...
    def hash
      [ad_audio_loudness_level, ad_insertion, add_cdns, beacon_set, channel_type, cidr_whitelist, ip_whitelist, encryption, event_length, hls_endlist, live_dvr_ads_window_duration, live_dvr_sliding_window_duration, live_stream, max_hls_protocol_version, notifications, outputs, protocol, reconnect_time, region, rtmp_credentials, rtmp_ip_whitelist, slate, static, videocloud].hash
    end
