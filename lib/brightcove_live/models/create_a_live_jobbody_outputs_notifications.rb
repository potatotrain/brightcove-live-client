...
module BrightcoveLive
  class CreateALiveJobbodyOutputsNotifications
    # Destination for the notification.
    attr_accessor :url

    # Event to send the notification for.
    attr_accessor :event

    # Credentials The name of the credentials configured in your account for this address
