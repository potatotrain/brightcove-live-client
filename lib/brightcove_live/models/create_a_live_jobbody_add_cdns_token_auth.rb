...
module BrightcoveLive
  ...
  class CreateALiveJobbodyAddCdnsTokenAuth
    ...
    def self.openapi_types
      {
        ...
        :'key' => :'String',
        :'token_name' => :'String',
        :'media' => :'CreateALiveJobbodyAddCdnsTokenAuthMedia'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'token_name')
    ...
    def hash
      [auth_type, key, token_name, media].hash
    end
