...
module BrightcoveLive
  class ApplicationApplicationAdConfiguration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'response_type')
      ...
      if attributes.has_key?(:'ad_configuration_variables')
    ...
    def hash
      [ad_configuration_description, response_type, headers, ad_configuration_strategy, ad_configuration_transforms, ad_configuration_url_format, ad_configuration_variables].hash
    end
