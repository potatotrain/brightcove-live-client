...
module BrightcoveLive
  ...
  class CreateVodClipbodyOutputsVideocloudVideoGeo
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BrightcoveLive::CreateVodClipbodyOutputsVideocloudVideoGeo` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BrightcoveLive::CreateVodClipbodyOutputsVideocloudVideoGeo`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'exclude_countries')
        self.exclude_countries = attributes[:'exclude_countries']
      end
    ...
    def list_invalid_properties
      ...
      if @exclude_countries.nil?
        invalid_properties.push('invalid value for "exclude_countries", exclude_countries cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @exclude_countries.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          exclude_countries == o.exclude_countries &&
    ...
    def hash
      [countries, exclude_countries, restricted].hash
    end
