...
module BrightcoveLive
  class CreateALiveJobbodyAddCdns
    ...
    def self.openapi_types
      {
        ...
        :'protocol' => :'String',
        :'vendor' => :'String',
        :'token_auth' => :'CreateALiveJobbodyAddCdnsTokenAuth'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'token_auth')
    ...
    def hash
      [label, prepend, protocol, vendor, token_auth].hash
    end
